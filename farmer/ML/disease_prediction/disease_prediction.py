...
model_path = r'C:\xampp\htdocs\agriculture-portal-main\farmer\ML\disease_prediction\plant_disease_model.h5'  # Replace with the actual path
...
disease_dic = {
    ...
    'Corn_(maize)__Common_rust': """ <b>Crop</b>: Corn(maize) <br/>Disease: Common Rust<br/>
        <br/> Cause of disease:
    ...
    'Grape__Esca(Black_Measles)': """ <b>Crop</b>: Grape <br/>Disease: Black Measles<br/>
        <br/> Cause of disease:
    ...
    'Grape__Leaf_blight(Isariopsis_Leaf_Spot)': """ <b>Crop</b>: Grape <br/>Disease: Leaf Blight<br/>
        <br/> Cause of disease:
    ...
    'Grape__Leaf_blight(Isariopsis_Leaf_Spot)': """<b> Crop</b> : Grape <br/> Disease: Leaf Spot""",


    'Orange__Haunglongbing(Citrus_greening)': """ <b>Crop</b>: Orange <br/>Disease: Citrus Greening<br/>
        <br/> Cause of disease:
    ...
    'Pepper,bell__Bacterial_spot': """ <b>Crop</b>: Pepper <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Pepper,bell__healthy': """ <b>Crop</b>: Pepper <br/>Disease: No disease<br/>
...
loaded_model.classes = disease_classes

# Assuming your model's output layer is a Dense layer with softmax activation
loaded_model.layers[-1] = tf.keras.layers.Dense(len(disease_classes), activation='softmax', name='dense_output')

uploadedFile = sys.argv[1]
img = image.load_img(uploadedFile, target_size=(64, 64))
...
# sp = Markup(str(disease_dic[predicted_class]))

# Print or return the result as needed
print(Markup(str(disease_dic[disease_classes[np.argmax(loaded_model.predict(img_array))]])))
